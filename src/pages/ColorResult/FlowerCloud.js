        ...
        >
          <Background height="1370px" top="0" translate="translate(-50%, 0)">
            ...
            >
              ...
              <br />
              흰색이 다른 모든 색들과 잘 어울리듯이
              <br />
              어디에서도 사람들과 잘 어울릴 수 있는 성격
              <br />
              으로, 깨끗하고 맑은 이미지로 기억됩니다.
            </ColorResult1>

            <CardWrapper height="310px" padding="15px 0 0 0">
              <Result2>
                당신은 놀라운 적응력을 가졌습니다. 섬세한
                <br />
                배려심으로 상대방과 빠르게 친해지고 새로운
                <br />
                환경에 잘 적응합니다.
                <br />
                부드럽고 다정한 성격을 지닌 반면 단호하게
                <br />
                자신의 의사를 표현할 줄 아는 강단도 있습니다.
              </Result2>
              <Result3>
                신중함이 경계심으로 이어질 수 있습니다.
                <br />
                이는 사람과 깊게 친해지는 데에 어려움을
                <br />
                주고 때로는 상처를 받기도 합니다.
              </Result3>
            </CardWrapper>
