        ...
        >
          <Background height="1370px" top="0" translate="translate(-50%, 0)">
            ...
            <CardWrapper height="300px" padding="15px 0 0 0">
              <Result2>
                매우 진취적이며, 자유를 갈망하고, 행복을 추구
                <br />
                합니다. 어떤 일을 하든 포기하지 않고, 항상 열정적
                <br />
                으로 일에 임합니다. 언제나 앞으로 나아가려 하고,
                <br />
                일을 할 때 항상 적극적인 자세로 임합니다.
              </Result2>
              <Result3>
                열정이 과다해서 타인의 의견을 무시하는 경향이
                <br />
                있을 수 있습니다.
                <br />
                또한 스스로에게 열중하여 상처가 될 수 있는 말을
                <br />
                서슴없이 하는 경향이 있습니다.
              </Result3>
            </CardWrapper>
