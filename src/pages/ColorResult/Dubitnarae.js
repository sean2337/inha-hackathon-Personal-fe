        ...
        >
          <Background height="1408px" top="0" translate="translate(-50%, 0)">
            ...
            <ColorResult1
              ...
              contentHeight="155px"
            >
              남다름과 우아함을 가진 당신은 오묘한 분위기를
              <br />
              주는 '두빛나래'와 닮았습니다.
              <br />
              자기 자신에 대한 고찰과 홀로 생각하기를 좋아하여
              <br />
              스스로에 대한 확신이 굳건합니다.
            </ColorResult1>
            ...
            <CardWrapper height="320px" padding="15px 0 0 0">
              <Result2>
                신비로운 분위기를 지녔습니다.
                <br />
                독창적인 생각으로 가득 차 창의적인 모습을 보여
                <br />
                줍니다.
                <br />
                반면 내면은 상대적으로 평온한 경우가 많습니다.
                <br />
                개성 넘치는 아이디어와 차분한 태도로 인하여
                <br />
                다른 사람에 비해 생각이 매우 깊습니다.
              </Result2>
              <Result3>
                당신의 고상함은 자칫 우울해 보일 수 있습니다.
                <br />
                또한 프라이드가 강하고 확신에 찬 태도가 상황에
                <br />
                따라 오만함으로 비춰질 가능성이 있습니다.
              </Result3>
            </CardWrapper>
