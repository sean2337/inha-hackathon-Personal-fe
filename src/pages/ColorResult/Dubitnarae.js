        ...
        >
          <Background height="1370px" top="0" translate="translate(-50%, 0)">
            ...
            <ColorResult1
              ...
              contentHeight="155px"
            >
              남다름과 우아함을 가진 당신은 오묘한
              <br />
              분위기를 주는 '두빛나래'와 닮았습니다.
              <br />
              자기 자신에 대한 고찰과 홀로 생각하기를
              <br />
            ...
            <CardWrapper height="340px" padding="15px 0 0 0">
              <Result2>
                신비로운 분위기를 지녔습니다. 독창적인
                <br />
                생각으로 가득 차 창의적인 모습을 보여줍니
                <br />
                다. 반면 내면은 상대적으로 평온한 경우가
                <br />
                많습니다. 개성 넘치는 아이디어와 차분한
                <br />
                태도로 인하여 다른 사람에 비해 생각이
                <br />
                매우 깊습니다.
              </Result2>
              <Result3>
                당신의 고상함은 자칫 우울해보일 수 있습니
                <br />
                다. 또한 프라이드가 강하고 확신에 찬 태도가
                <br />
                상황에 따라 오만함으로 비춰질 가능성이
                <br />
                있습니다.
              </Result3>
            </CardWrapper>
