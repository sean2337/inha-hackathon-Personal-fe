        ...
        >
          <Background height="1370px" top="0" translate="translate(-50%, 0)">
            ...
            <CardWrapper height="300px" padding="15px 0 0 0">
              <Result2>
                당신은 온화하고 마음이 상냥하여 솔직한 면을
                <br />
                가지고 있습니다. 특히나 조화로운 삶을 선호하여
                <br />
                어디에서든지 잘 들어주는 사람입니다.
                <br />
                평소 성실한 모습으로 주변 사람들에게 존경을
                <br />
                받습니다.
              </Result2>
              <Result3>
                분쟁을 좋아하지 않는 성향으로 인해 필요 이상으로
                <br />
                주위 사람들에게 맞추려고 하는 성향이 있습니다.
                <br />
                조금은 스스로 아껴주는 노력도 필요합니다.
              </Result3>
            </CardWrapper>
