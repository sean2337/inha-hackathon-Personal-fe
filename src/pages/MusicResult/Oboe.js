      ...
      {loading === true ? (
        ...
        <Background height="1450px" top="0px" translate="translate(-50%, 0)">
          ...
          >
            ...
            <br />
            합주 소리를 뚫고 음정을 조율할 때 기준이
            <br />
            되어줄 정도로 관통력이 매우 큽니다.
            <br />알 수 없는 소리들이 뒤엉켜 있으면 따뜻하게
            <br />
            이들의 든든한 표지판이나 지지대가 되어주기도
            <br />
            합니다.
          </MusicResult1>
          ...
          <CardWrapper height="325px" padding="15px 0 0 0">
            <Result2>
              ...
              리더쉽이 있습니다.
              <br />
              직관적으로 상황을 파악하는데 뛰어나고 도움을
              <br />
              주기 위해 적극적으로 노력하는 사람입니다.
              <br />
              또한 전형적인 모범이 되는 모습을 보여주기도
              <br />
              합니다.
            </Result2>
            <Result3>
              다른 사람들과 잘 어울리기도 하지만, 가끔 <br />
              타인의 문제에 지나치게 관여할 때가 있습니다.
              <br />
