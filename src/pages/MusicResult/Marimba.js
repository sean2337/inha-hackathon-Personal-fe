      ...
      {loading === true ? (
        ...
        <Background height="1490px" top="0px" translate="translate(-50%, 0)">
          ...
          >
            ...
            <br />
            실로폰 밑에 여러 개의 관들이 연결되어 있는
            <br />
            타악기입니다.
            <br />
            개성이 넘치는 음색 때문에 합주보다는 독주나
            <br />
            협주곡에 가장 많이 등장하고, 또 광고나 앱 등<br />
            사람들의 이목을 사로잡아야 하는 곳에서 자주
            <br />
            찾아들을 수 있습니다.
          </MusicResult1>
          ...
          <CardWrapper height="300px" padding="15px 0 0 0">
            <Result2>
              맑고 둥글한 성격으로 사람들과 쉽게 친해지며
              <br />
              재미있는 분위기를 잘 만들어갑니다. 좋고 싫음이
              <br />
              분명하고 솔직하여 때에 따라 친근함과 냉정함을
              <br />
              적절히 구분할 수 있습니다.
            </Result2>
            <Result3>
              가끔씩 수다가 많고, 진지함이 부족해보이는 모습을
              <br />
              보여주기도 합니다.
              <br />
              또한 책임감이 막중한 일을 어려워하는 경향이 있어
              <br />
              조직적인 업무에는 잘 맞지 않을 수 있습니다.
            </Result3>
          </CardWrapper>
