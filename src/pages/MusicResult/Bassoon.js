    ...
    <>
      {loading === true ? (
        ...
        <Background height="1442px" top="0px" translate="translate(-50%, 0)">
          ...
          <audio src="바순.mp3" autoplay controls />
          ...
          <CardWrapper height="300px" padding="15px 0 0 0">
            <Result2>
              온화하고 조화를 추구하여 어른스러운 매력이
              <br />
              있습니다. 또한 자신만의 영역이 깊어 독립적이고
              <br />
              내면이 단단하기 때문에 주변 사람들이 당신에게
              <br />
              의지하기도 합니다.
            </Result2>
            <Result3>
              상대방과의 충돌을 피하고자 하는 모습이 자칫
              <br />
              우유부단해 보일 수 있습니다. 또한 타인과의
              <br />
              갈등이 깊어졌을 때 문제 자체를 해결하기보다는
              <br />
              회피하는 경향이 있습니다.
            </Result3>
          </CardWrapper>
