    ...
    <>
      {loading === true ? (
        ...
        <Background height="1500px" top="0px" translate="translate(-50%, 0)">
          ...
          <audio src="오르간.mp3" autoplay controls />
          ...
          <MusicResult1
            ...
            contentHeight="245px"
          >
            여러 개의 관들 속에서 공기가 갈라지며 떨리는
            <br />
            것에 의해 나는 오르간 소리는 고전적이면서
            <br />
            화려합니다. 악기의 크기가 거대한 만큼,
            <br />
            혼자서도 오케스트라를 연상시킬 정도로
            <br />
            풍부한 음색을 자랑하고, 특유의 신성한 분위기는
            <br />
            기독교에서 오랫동안 사랑받아 왔습니다.
            <br />
            성량이 큰 만큼 주로 독주나 협주에서 볼 수<br />
            있습니다.
          </MusicResult1>

          <CardWrapper height="300px" padding="15px 0 0 0">
            <Result2>
              당신의 대담함과 의지력은 같은 팀의 일원들을
              <br />
              긴장시켜 최대의 효율을 이끌어냅니다.
              <br />
              또한 따뜻함보다는 합리성을, 인기보단 옳은 것을
              <br />
              추구하는 당신의 이성적인 매력은 주변 사람들을
              <br />
              끌어들이기도 합니다.
            </Result2>
            <Result3>
              지나치게 비관적으로 말하는 경향이 있어 본의
              <br />
              아니게 타인에게 모욕을 주거나 공격적으로
              <br />
              비춰질 수도 있습니다.
            </Result3>
          </CardWrapper>
