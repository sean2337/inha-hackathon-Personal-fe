      ...
      {loading === true ? (
        ...
        <Background height="1370px" top="0px" translate="translate(-50%, 0)">
          ...
          <MusicResult1
            ...
            contentHeight="260px"
          >
            여러 개의 관들 속에서 공기가 갈라지며
            <br />
            떨리는 것에 의해 나는 오르간 소리는
            <br />
            고전적이면서 화려합니다.
            <br />
            악기의 크기가 거대한 만큼, 혼자서도
          ...
          <CardWrapper height="310px" padding="15px 0 0 0">
            <Result2>
              당신의 대담함과 의지력은 같은 팀의 일원들
              <br />을 긴장시켜 최대의 효율을 이끌어냅니다.
              <br />
              또한 따뜻함보다는 합리성을, 인기보단 옳은
              <br />
              것을 추구하는 당신의 이성적인 매력은 주변
              <br />
              사람들을 끌어들이기도 합니다.
            </Result2>
            <Result3>
              지나치게 비관적으로 말하는 경향이 있어
              <br />
              본의 아니게 타인에게 모욕을 주거나 공격적
              <br />
              으로 비춰질 수도 있습니다.
            </Result3>
          </CardWrapper>
