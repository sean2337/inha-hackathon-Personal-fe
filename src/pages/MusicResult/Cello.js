      ...
      {loading === true ? (
        ...
        <Background height="1442px" top="0px" translate="translate(-50%, 0)">
          ...
          <MusicResult1
            ...
            contentHeight="200px"
          >
            사람의 목소리와 가장 닮아 있어 친숙한 느낌을
            <br />
            주는 첼로 소리에서는 풍성한 울림 또한 느낄 수<br />
            있습니다. 연주자가 의자에 앉아 첼로를 가슴에
            <br />
            품고 연주하기 때문에 ‘연주자의 심장에 가장
            <br />
            가까운 악기’ 라고도 불리며 가장 친숙한 음색으로
            <br />
            듣는 사람에게 따뜻함을 전해줍니다.
          </MusicResult1>
          ...
          <CardWrapper height="280px" padding="15px 0 0 0">
            <Result2>
              감성적이고 공감을 잘 해주며 사람에게 관심이
              <br />
              많기 때문에 당신에게 주변 사람들이 편하게
              <br />
              속내를 잘 털어놓습니다. 팀 안의 화합을 추구하는
              <br />
              성격으로 이타적인 당신은 함께 있는 팀원들에게
              <br />
              긍정적인 영향 을 줍니다.
            </Result2>
            <Result3>
              주변 사람들에게만 집중하여 스스로에게 소홀해져
              <br />
              번아웃이 오기 쉽습니다.
            </Result3>
          </CardWrapper>
