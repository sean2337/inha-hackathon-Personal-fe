      ...
      {loading === true ? (
        ...
        <Background height="1550px" top="0px" translate="translate(-50%, 0)">
          ...
          <MusicResult1
            ...
            contentHeight="200px"
          >
            전세계에서 보편적으로 가장 널리 알려진 피아노는
            <br />
            거의 모든 음역대와 모든 가락이 있는 곡을 홀로
            <br />
            소화할 수 있어 피아노 한 대로 독주곡에서부터
            <br />
            오케스트라에서까지 눈부신 존재감을 보여줍니다.
            <br />
            또한 피아노의 선율은 어떤 장르에도 구애 받지 않는
            <br />
            유연함을 지니고 있습니다.
          </MusicResult1>

          <CardWrapper height="385px" padding="15px 0 0 0">
            <Result2>
              조용하지만 따뜻하고 친근한 당신은 주변 사람들
              <br />
              에게 애정이 가득한 만큼 주변에서 받는 사랑과
              <br />
              믿음이 두텁습니다.
              <br />
              또한 타인에 대해 깊은 책임감을 가지고 스스로에
              <br />
              대한 신뢰를 갖기 위해 헌신적인 모습을 보여주기도
              <br />
              합니다.
            </Result2>
            <Result3>
              가까운 사람들에겐 한없이 가까우나, 신중한 성격
              <br />
              으로 새로운 사람들에겐 자칫 다가가기 어려운
              <br />
              방어적인 사람으로 비춰질 수도 있습니다 말 또한
              <br />
              자기자신에게 철저한 원칙을 적용하기 때문에 기대
              <br />
              이하의 성과를 내었을 때 필요 이상으로 낙담하는
              <br />
              경우가 있습니다.
            </Result3>
          </CardWrapper>
