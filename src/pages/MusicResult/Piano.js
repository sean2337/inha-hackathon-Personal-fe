        ...
        <Background height="1550px" top="0px" translate="translate(-50%, 0)">
          ...
          <CardWrapper height="390px" padding="15px 0 0 0">
            <Result2>
              ...
              믿음이 두텁습니다.
              <br />
              타인에 대해 깊은 책임감을 가지고 스스로에 대한
              <br />
              신뢰를 갖기 위해 헌신적인 모습을 보여주기도
              <br />
              합니다.
            </Result2>
            <Result3>
              가까운 사람들에겐 한없이 가까우나, 신중한
              <br />
              성격으로 새로운 사람들에겐 자칫 다가가기 <br />
              어려운 방어적인 사람으로 비춰질 수도 있습니다. <br />말 또한
              자기자신에게 철저한 원칙을 적용하기 <br />
              때문에, 기대 이하의 성과를 내었을 때 필요 이상으로 낙담하는 경우가
              있습니다.
            </Result3>
          </CardWrapper>
