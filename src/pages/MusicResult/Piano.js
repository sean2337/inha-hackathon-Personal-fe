      ...
      {loading === true ? (
        ...
        <Background height="1370px" top="0px" translate="translate(-50%, 0)">
          ...
          <MusicResult1
            ...
            contentHeight="220px"
          >
            전세계에서 보편적으로 가장 널리 알려진
            <br />
            피아노는 거의 모든 음역대와 모든 가락이
            <br />
            있는 곡을 홀로 소화할 수 있어 피아노 한<br />
            대로 독주곡에서부터 오케스트라에서까지
            <br />
            눈부신 존재감을 보여줍니다.
            <br />
            또한 피아노의 선율은 어떤 장르에도 구애
            <br />
            받지 않는 유연함을 지니고 있습니다.
          </MusicResult1>

          <CardWrapper height="420px" padding="15px 0 0 0">
            <Result2>
              조용하지만 따뜻하고 친근한 당신은 주변
              <br />
              사람들에게 애정이 가득한 만큼 주변에서
              <br />
              받는 사랑과 믿음이 두텁습니다.
              <br />
              또한 타인에 대해 깊은 책임감을 가지고
              <br />
              스스로에 대한 신뢰를 갖기 위해 헌신적인
              <br />
              모습을 보여주기도 합니다.
            </Result2>
            <Result3>
              가까운 사람들에겐 한없이 가까우나,
              <br />
              신중한 성격으로 새로운 사람들에겐 자칫
              <br />
              다가가기 어려운 방어적인 사람으로 비춰질
              <br />
              수도 있습니다
              <br />
              말또한 자기자신에게 철저한 원칙을
