    ...
    <>
      {loading === true ? (
        ...
        <Background height="1465px" top="0px" translate="translate(-50%, 0)">
          ...
          <audio src="팀파니.mp3" autoplay controls />
          ...
          >
            ...
            <br />
            타악기의 왕으로 불립니다. 합주에서 템포를 <br />
            이끌어가는 주도적인 역할을 하며, 악곡에서 <br />
            선율적으로 큰 비중을 차지하진 않지만 음악이 <br />
            절정으로 치달을 때 비로소 압도적인 웅장함을 <br />
            보여줍니다.
          </MusicResult1>

          <CardWrapper height="305px" padding="15px 0 0 0">
            <Result2>
              넘치는 카리스마로 주변 사람들이 앞으로 <br />
              나아갈 수 있도록 안정적으로 이끌어줍니다.
              <br />
              절도와 무게감이 있어 어떠한 활동을 할 때,
              <br />
              이성적이고 주도적인 모습을 보여줍니다.
            </Result2>
            <Result3>
              자칫 지나치게 이성적인 태도로 주변 사람들에게
              <br />
              상처를 줄 수 있습니다.
              <br />
              가끔씩 의견이 다른 사람들을 존중하는 태도가
              <br />
              부족해 보일 수 있습니다.
            </Result3>
          </CardWrapper>
