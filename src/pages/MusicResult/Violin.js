      ...
      {loading === true ? (
        ...
        <Background height="1470px" top="0px" translate="translate(-50%, 0)">
          ...
          <MusicResult1
            ...
            contentHeight="200px"
          >
            합주에서 주요한 선율을 이끌어 가는 바이올린의
            <br />
            선율은 어떤 악기와도 잘 어울리는 악기계의 ‘인싸’
            <br />
            입니다.
            <br />
            넓은 음역대로 빠른 속주부터 서정적인 멜로디까지
            <br />
            무한하게 변화할 수 있어 다양한 장르에서 폭넓게
            <br />
            연주되는 악기입니다.
          </MusicResult1>
          ...
          <CardWrapper height="320px" padding="15px 0 0 0">
            <Result2>
              당신은 어떤 사람과도 잘 어울리며 화려한 성격으로
              <br />팀 내에서 분위기 메이커 역할을 맡고 있습니다.
              <br />
              풍부한 표현력으로 타인의 마음을 이끌어 내는
              <br />
              따뜻한 면을 지녀 여기 저기에서 찾는 사람이 많은
              <br />
              편입니다.
            </Result2>
            <Result3>
              표현력이 풍부한 만큼 자칫 지나치게 감성적으로
              <br />
              보일 수 있습니다.
              <br />
              또한 가끔씩 조건이 맞지 않으면 팀 내의 분위기를
              <br />
              흐려 놓을 수 있습니다.
            </Result3>
          </CardWrapper>
