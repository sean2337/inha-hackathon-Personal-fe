      ...
      {loading === true ? (
        ...
        <Background height="1470px" top="0px" translate="translate(-50%, 0)">
          ...
          >
            ...
            <br />
            어떤 악기와도 잘 어울리는 선율은 악기계의 <br />
            ‘인싸’입니다.
            <br />
            넓은 음역대를 갖고 있어 빠른 속주부터 서정적인
            <br />
            멜로디까지 무한하게 변화할 수 있기 때문에,
            <br />
            다양한 장르에서 폭넓게 연주되는 악기입니다.
          </MusicResult1>

          <CardWrapper height="320px" padding="15px 0 0 0">
            <Result2>
              당신은 어떤 사람과도 잘 어울리며, 화려한
              <br />
              성격으로 팀 내에서 분위기 메이커 역할을 맡고
              <br />
              있습니다. 풍부한 표현력으로 타인의 마음을
              <br />
              이끌어 내는 따뜻한 면을 지녀 여기 저기에서
              <br />
              찾는 사람이 많은 편입니다.
            </Result2>
            <Result3>
